...
from api_client_generator._private.common.converters import hyphen_to_snake
from api_client_generator._private.common.defaults import DEFAULT_ENDPOINT_REST_DECORATOR_NAME
from api_client_generator._private.common.get_type_from_ref_in_camel import get_type_from_ref_in_camel
...
from api_client_generator._private.description_tools import get_value_from_swagger_part_recursively
from api_client_generator._private.endpoints_factory.common import (
    create_endpoint as create_endpoint_common,
)
from api_client_generator._private.rest_api_tools.models_aliased import (
    PathParam,
    QueryParam,
    RestApiMethodType,
)
...
if TYPE_CHECKING:
    from api_client_generator._private.rest_api_tools.rest_method_model import RestApiMethod
